<div class="slider_bg"><!-- start slider -->
	<div class="container">
		<div id="da-slider" class="da-slider text-center">
			<div class="da-slide">
				<h2>Elève.TN</h2>
				<p> Espace administratif : <span class="hide_text"> Elève.TN offre un espace administratif de gestion de l'établissement éducatif.Une informatisation des données : des emplois ,des cours , des enseignants, des profils des élèves de tous les niveaux..</span></p>
