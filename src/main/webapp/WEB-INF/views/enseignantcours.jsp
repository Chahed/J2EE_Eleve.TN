...
<html>
  ...
  <body class="skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <h1>
 Ajouter des cours à cet enseignant 
</h1></section></br>
      <div class="box box-info">
      <div class="box-header">

		
		<h4> L'enseignant ${enseignant.nom } ${enseignant.prenom } possède les cours suivant : </h4>
...
<h4>Si Vous voulez ajouter un autre cours à ${enseignant.nom }</h4>
...
<input type="submit" value="<spring:message text="Ajouter"/>" class="btn bg-teal btn-sm"/>
</form>
